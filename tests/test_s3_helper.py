...
def test_setup_success_txt_file_exists():
    ...
    s3res.Bucket('nc-de-databakers-csv-store-20202').upload_file('./setup_success_csv_input.txt', 'input_csv_key/setup_success_csv_input.txt')
...
def test_csv_files_are_uploaded_successfully_to_the_input_key_within_bucket():
    ...
    s3res.Bucket('nc-de-databakers-csv-store-20202').upload_file('./setup_success_csv_input.txt', 'input_csv_key/setup_success_csv_input.txt')
    s3_upload_csv_files()
    objects = s3cli.list_objects(Bucket='nc-de-databakers-csv-store-20202', Prefix='input_csv_key/')['Contents']
...
#     s3 = boto3.client('s3')
#     if s3_list_prefix_buckets() == None:
